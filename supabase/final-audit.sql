-- Dois Tons - auditoria final v1.0
-- Preserva a autoria dos registros ao alternar perfis no mesmo navegador
-- e corrige vínculos primários que possam ter sido remapeados por versões anteriores.
-- Seguro para executar após as migrações anteriores.

-- o user_id original de cada perfil é imutável e tem prioridade sobre vínculos de aparelho
